...
if (!isset($_SESSION["User"])) {
    ...
    $SqlQuery = "UPDATE CarImages SET 
 CarId = :carid , ImagePath = :imagePath WHERE Id = :id";
    $CarImagesQuery = $DbConnect->prepare($SqlQuery);
    $CarImagesQuery->bindParam(':carid', $CarId);
    $CarImagesQuery->bindParam(':imagePath', basename($_FILES["imagefile"]["name"]));
    $CarImagesQuery->bindParam(':id', $ImageId);
